...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    Page<ArticleProjection> getArticlesByPages(Pageable pageable) ;
    ...
    Page<ArticleProjection> getArticlesByWord( String word , Pageable pageable) ;

    Optional<Article> findArticleByTitle(String title) ;

    Page<ArticleProjection> findArticlesByCategory_CategoryName(String categoryName , Pageable pageable) ;
